jQuery("#simulation")
  .on("click", ".s-c8ec0a9a-3531-4779-bdb5-bd829f9e0fbf .click", function(event, data) {
  ...
  .on("pageload", ".s-c8ec0a9a-3531-4779-bdb5-bd829f9e0fbf .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-c8ec0a9a-3531-4779-bdb5-bd829f9e0fbf .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseenter dragenter", ".s-c8ec0a9a-3531-4779-bdb5-bd829f9e0fbf .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-c8ec0a9a-3531-4779-bdb5-bd829f9e0fbf #s-Button_1 > .borderLayer" ],
                    "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-c8ec0a9a-3531-4779-bdb5-bd829f9e0fbf #s-Button_2 > .borderLayer" ],
                    "attributes": {
                      "border-top-color": "#FD9727",
                      "border-right-color": "#FD9727",
                      "border-bottom-color": "#FD9727",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-c8ec0a9a-3531-4779-bdb5-bd829f9e0fbf #s-Button_3 > .borderLayer" ],
                    "attributes": {
                      "border-top-color": "#FD9727",
                      "border-right-color": "#FD9727",
                      "border-bottom-color": "#FD9727",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-c8ec0a9a-3531-4779-bdb5-bd829f9e0fbf #s-Button_4 > .borderLayer" ],
                    "attributes": {
                      "border-top-color": "#FD9727",
                      "border-right-color": "#FD9727",
                      "border-bottom-color": "#FD9727",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-c8ec0a9a-3531-4779-bdb5-bd829f9e0fbf #s-Button_5 > .borderLayer" ],
                    "attributes": {
                      "border-top-color": "#FD9727",
                      "border-right-color": "#FD9727",
                      "border-bottom-color": "#FD9727",
