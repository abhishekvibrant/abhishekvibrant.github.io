jQuery("#simulation")
  .on("click", ".s-b50784be-bc4d-4a49-8c9a-dcb8bac2426c .click", function(event, data) {
  ...
  .on("pageload", ".s-b50784be-bc4d-4a49-8c9a-dcb8bac2426c .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-b50784be-bc4d-4a49-8c9a-dcb8bac2426c .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseenter dragenter", ".s-b50784be-bc4d-4a49-8c9a-dcb8bac2426c .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-b50784be-bc4d-4a49-8c9a-dcb8bac2426c #s-Button_1 > .borderLayer" ],
                    "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-b50784be-bc4d-4a49-8c9a-dcb8bac2426c #s-Button_2 > .borderLayer" ],
                    "attributes": {
                      "border-top-color": "#FD9727",
                      "border-right-color": "#FD9727",
                      "border-bottom-color": "#FD9727",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-b50784be-bc4d-4a49-8c9a-dcb8bac2426c #s-Button_3 > .borderLayer" ],
                    "attributes": {
                      "border-top-color": "#FD9727",
                      "border-right-color": "#FD9727",
                      "border-bottom-color": "#FD9727",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-b50784be-bc4d-4a49-8c9a-dcb8bac2426c #s-Button_4 > .borderLayer" ],
                    "attributes": {
                      "border-top-color": "#FD9727",
                      "border-right-color": "#FD9727",
                      "border-bottom-color": "#FD9727",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-b50784be-bc4d-4a49-8c9a-dcb8bac2426c #s-Button_5 > .borderLayer" ],
                    "attributes": {
                      "border-top-color": "#FD9727",
                      "border-right-color": "#FD9727",
                      "border-bottom-color": "#FD9727",
