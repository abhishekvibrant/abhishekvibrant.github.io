jQuery("#simulation")
  .on("click", ".s-edaa0dbf-9c84-4d4c-b70c-322b0c9bece3 .click", function(event, data) {
  ...
  .on("pageload", ".s-edaa0dbf-9c84-4d4c-b70c-322b0c9bece3 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-edaa0dbf-9c84-4d4c-b70c-322b0c9bece3 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseenter dragenter", ".s-edaa0dbf-9c84-4d4c-b70c-322b0c9bece3 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-edaa0dbf-9c84-4d4c-b70c-322b0c9bece3 #s-Button_1 > .borderLayer" ],
                    "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-edaa0dbf-9c84-4d4c-b70c-322b0c9bece3 #s-Button_2 > .borderLayer" ],
                    "attributes": {
                      "border-top-color": "#FD9727",
                      "border-right-color": "#FD9727",
                      "border-bottom-color": "#FD9727",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-edaa0dbf-9c84-4d4c-b70c-322b0c9bece3 #s-Button_3 > .borderLayer" ],
                    "attributes": {
                      "border-top-color": "#FD9727",
                      "border-right-color": "#FD9727",
                      "border-bottom-color": "#FD9727",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-edaa0dbf-9c84-4d4c-b70c-322b0c9bece3 #s-Button_4 > .borderLayer" ],
                    "attributes": {
                      "border-top-color": "#FD9727",
                      "border-right-color": "#FD9727",
                      "border-bottom-color": "#FD9727",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-edaa0dbf-9c84-4d4c-b70c-322b0c9bece3 #s-Button_5 > .borderLayer" ],
                    "attributes": {
                      "border-top-color": "#FD9727",
                      "border-right-color": "#FD9727",
                      "border-bottom-color": "#FD9727",
