jQuery("#simulation")
  .on("click", ".s-4a754f0e-08cf-4e2f-9e10-2907d558bb0f .click", function(event, data) {
  ...
  .on("pageload", ".s-4a754f0e-08cf-4e2f-9e10-2907d558bb0f .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-4a754f0e-08cf-4e2f-9e10-2907d558bb0f .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseenter dragenter", ".s-4a754f0e-08cf-4e2f-9e10-2907d558bb0f .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-4a754f0e-08cf-4e2f-9e10-2907d558bb0f #s-Button_7 > .backgroundLayer > .colorLayer" ],
                    "attributes": {
                      "background-color": "#FFFFFF"
                    }
                  },{
                    "target": [ "#s-4a754f0e-08cf-4e2f-9e10-2907d558bb0f #s-Button_7 > .backgroundLayer > .imageLayer" ],
                    "attributes": {
