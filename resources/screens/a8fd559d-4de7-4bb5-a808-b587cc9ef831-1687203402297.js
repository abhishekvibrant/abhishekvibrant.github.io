jQuery("#simulation")
  .on("click", ".s-a8fd559d-4de7-4bb5-a808-b587cc9ef831 .click", function(event, data) {
  ...
  .on("pageload", ".s-a8fd559d-4de7-4bb5-a808-b587cc9ef831 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-a8fd559d-4de7-4bb5-a808-b587cc9ef831 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseenter dragenter", ".s-a8fd559d-4de7-4bb5-a808-b587cc9ef831 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-a8fd559d-4de7-4bb5-a808-b587cc9ef831 #s-Button_6 > .backgroundLayer > .colorLayer" ],
                    "attributes": {
                      "background-color": "#FFFFFF"
                    }
                  },{
                    "target": [ "#s-a8fd559d-4de7-4bb5-a808-b587cc9ef831 #s-Button_6 > .backgroundLayer > .imageLayer" ],
                    "attributes": {
