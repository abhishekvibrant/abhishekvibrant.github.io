jQuery("#simulation")
  .on("click", ".s-143ba14e-73ac-4180-a80d-b8035bbfddd8 .click", function(event, data) {
  ...
  .on("pageload", ".s-143ba14e-73ac-4180-a80d-b8035bbfddd8 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-143ba14e-73ac-4180-a80d-b8035bbfddd8 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseenter dragenter", ".s-143ba14e-73ac-4180-a80d-b8035bbfddd8 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-143ba14e-73ac-4180-a80d-b8035bbfddd8 #s-Button_6 > .backgroundLayer > .colorLayer" ],
                    "attributes": {
                      "background-color": "#FFFFFF"
                    }
                  },{
                    "target": [ "#s-143ba14e-73ac-4180-a80d-b8035bbfddd8 #s-Button_6 > .backgroundLayer > .imageLayer" ],
                    "attributes": {
