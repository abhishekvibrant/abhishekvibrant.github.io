jQuery("#simulation")
  .on("click", ".s-a5fbce44-ccfb-42e1-8ac6-8fbc424329dc .click", function(event, data) {
  ...
  .on("pageload", ".s-a5fbce44-ccfb-42e1-8ac6-8fbc424329dc .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-a5fbce44-ccfb-42e1-8ac6-8fbc424329dc .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseenter dragenter", ".s-a5fbce44-ccfb-42e1-8ac6-8fbc424329dc .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-a5fbce44-ccfb-42e1-8ac6-8fbc424329dc #s-Button_6 > .backgroundLayer > .colorLayer" ],
                    "attributes": {
                      "background-color": "#FFFFFF"
                    }
                  },{
                    "target": [ "#s-a5fbce44-ccfb-42e1-8ac6-8fbc424329dc #s-Button_6 > .backgroundLayer > .imageLayer" ],
                    "attributes": {
