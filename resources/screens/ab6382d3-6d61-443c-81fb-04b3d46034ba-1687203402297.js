jQuery("#simulation")
  .on("click", ".s-ab6382d3-6d61-443c-81fb-04b3d46034ba .click", function(event, data) {
  ...
  .on("pageload", ".s-ab6382d3-6d61-443c-81fb-04b3d46034ba .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-ab6382d3-6d61-443c-81fb-04b3d46034ba .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseenter dragenter", ".s-ab6382d3-6d61-443c-81fb-04b3d46034ba .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-ab6382d3-6d61-443c-81fb-04b3d46034ba #s-Button_7 > .backgroundLayer > .colorLayer" ],
                    "attributes": {
                      "background-color": "#FFFFFF"
                    }
                  },{
                    "target": [ "#s-ab6382d3-6d61-443c-81fb-04b3d46034ba #s-Button_7 > .backgroundLayer > .imageLayer" ],
                    "attributes": {
